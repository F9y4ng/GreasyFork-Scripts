...
`!!! 重大版本更新，请使用前仔细查看 !!!` [[键盘快捷键设置](https://github.com/F9y4ng/GreasyFork-Scripts/wiki/Font_Rendering#%E8%84%9A%E6%9C%AC%E8%8F%9C%E5%8D%95%E5%9B%BE)] `New`
...
> 请反馈问题的朋友注意：反馈脚本错误或样式显示问题，请把发生问题的**具体访问网址**、使用的**浏览器版本**、**脚本运行器版**、**相关错误的截图**（仅开此脚本的情况下的）、以及**具体操作流程**或**错误提示**（如果有的话）发出来，你遇到的问题不一定能在其他地方复现。请至[@Github](https://github.com/F9y4ng/GreasyFork-Scripts/issues)提交Issues。
...
`!!! 重大版本更新，请使用前仔细查看 !!!` [[键盘快捷键设置](https://github.com/F9y4ng/GreasyFork-Scripts/wiki/Google_Baidu_Switcher#%E8%84%9A%E6%9C%AC%E8%8F%9C%E5%8D%95%E6%A0%8F)] `New`
