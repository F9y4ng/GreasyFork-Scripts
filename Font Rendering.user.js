    ...
    try {
      ...
      new MutationObserver(mutations => {
        ...
        if (defCon.siteIndex === undefined) {
          ...
          SHOULD_FIX_STROKE() && deBounce(correctBoldErrorByStroke, 50, "fixstroke")(CONST_VALUES.fontStroke, { isCount: isAddedNodes });
