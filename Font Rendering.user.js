...
!(function () {
  ...
  !(async function () {
    ...
    const fontStyle_moz = `@-moz-document url-prefix(){#${defCon.id.shadowColor},#${defCon.id.fontFace},#${defCon.id.fontSmooth}{width:max-content!important}.${defCon.class.checkbox}+label,.${defCon.class.checkbox}:checked+label{margin:0 0 0 25px!important}}`;
    ...
    const fontStyle = fontStyle_db + fontStyle_container + fontStyle_moz + fontStyle_cp + fontStyle_tooltip + fontStyle_Progress + fontStyle_welcome;
    const tHTML = String(`
