...
!(function () {
  ...
  !(async function (loading) {
    ...
    setTimeout(() => {
      if (curWindowtop) {
        let Font_Set, Feed_Back, Exclude_site, Parameter_Settings;
