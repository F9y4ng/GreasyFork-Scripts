...
!(function () {
  ...
  function addStyle(T = "T", css, className, addToTarget, isReload = false, initType = "text/css", reNew = false) {
    RAFInterval(
      () => {
  ...
  !(async function () {
    ...
    function insertStyle(t) {
      try {
        addStyle("TS", tStyle, `${defCon.class.rndStyle}`, document.head, t);
      } catch (e) {
