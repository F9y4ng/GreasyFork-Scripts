...
- ## **Font Rendering.user.js** (`version 2021.07.11.2`)
  ...
  ```text
  + 新增字体替换关闭功能，与字体重写按钮复用，关闭字体重写后字体替换自动禁用。
  + 新增数据变更保存提示功能，优化使用体验。
  + 新增备份功能(Beta)：本地数据备份，可实现跨设备、跨浏览器数据共享，如遇问题请反馈。
    默认功能开启，如需关闭，请在代码中将 const isBackupFunction = true; 设置为 false.
...
- ## **Google & Baidu Switcher.user.js** (`version 3.3.20210704.1`)
