...
`version 2022.08.13.1` 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Font%20Rendering.user.js)】
...
```text
@ 优化冗余脚本执行的错误自检，可参阅排查清单 #117。
@ 优化本地字体检测功能，提升跨浏览器跨系统的识别率。
@ 修正一些已知的问题，优化代码。
```
...
`version 2022.08.13.1` 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Google%20%26%20Baidu%20Switcher.user.js)】
