...
- ## **Font Rendering.user.js** (`version 2021.07.29.1`)
  ...
  ```text
  @ 优化跨域检测，防止因页面跨域而造成全部渲染失效。
  @ 优化重置操作的新流程，提高体验性。
  @ 修正字体检测在部分网站失效的问题，修正字体名称错误。
  @ 修正CSS样式错误，优化代码。
  ```
