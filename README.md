...
- ## **Font Rendering.user.js** (`version 2021.07.03.2`)
  ...
  ```text
  + 增加字体列表排序，避免字体列表选择时混乱。

  @ 优化代码，修正若干bugs。
  @ 修正小尺寸屏幕因配置界面过长而不能保存的问题。
  @ 修正中文字体检测的错误，可通过中文字体名进行字体渲染。
  ```
...
- ## **Google & Baidu Switcher.user.js** (`version 3.3.20210703.1`)
