...
`version 2022.09.17.1` 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Font%20Rendering.user.js)】
...
```text
! 本次更新chromium内核低于88.0的浏览器将不再被兼容，Manifest V3后低版本浏览器兼容性会进一步降低。
@ 优化自定义代码提交的兼容性与容错性。
@ 修正一些已知的问题，优化代码。
```
...
`version 2022.09.17.1` 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Google%20%26%20Baidu%20Switcher.user.js)】
