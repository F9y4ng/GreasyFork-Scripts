...
- ## **Font Rendering.user.js** (`version 2021.08.03.2`)
  ...
  ```text
  @ 修正Firefox下选取文字发虚的bug。
  @ 优化字体描边为外部描边，增强文本字重设置敏感度。
