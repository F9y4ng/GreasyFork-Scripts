...
```text
+ 新增键盘快捷键(Alt+字母)操作脚本菜单的配置项。
@ 修正字体缩放引起的元素定位问题。Release Candidate!
@ 修正chrome96+版本中字体描边对粗体样式的渲染错误。
@ 优化配置页面样式，修正unicode-icon的样式问题。
@ 修正其他小bugs，优化代码。
```
...
>
> * **已知问题：** 因Firefox的Gecko内核对JS脚本及CSS限制，我们建议Firefox的用户谨慎使用该功能。
> * **未知情况：** 如在非Firefox浏览器中遇到样式异常或坐标偏移，请及时到 [@Github](https://github.com/F9y4ng/GreasyFork-Scripts/issues) 向我反馈。
