...
### version 2025.06.07.1 - 更新日志： 【🔥[安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Font%20Rendering.user.js)】

```log
@ 优化脚本样式插入函数为惰性函数，提升性能。
@ 修复字体缩放视口单位修正函数的一个隐藏Bug。
@ 修复一些已知的问题，优化代码，优化样式。
```
...
### version 2025.06.07.1 - 更新日志： 【🔥 [安装此脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Google%20%26%20Baidu%20Switcher.user.js)】

```log
@ 修复 you.com 的跳转按钮显示问题。
@ 优化 yandex.com 的跳转按钮样式。
@ 优化 bing.com 的跳转链接地址。
@ 修正一些已知问题，优化代码，优化样式。
```
