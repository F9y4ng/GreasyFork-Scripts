...
`version 2022.05.01.1` 【🔥 [安装脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Font%20Rendering.user.js)】
...
```text
@ 修正从早期版本跨版本直接升级至最新版本时已存储数据的兼容性错误（处置：初始化数据）
@ 修正数据被非法篡改时的解析错误（处置：初始化数据）
# 注意：防止数据意外丢失，请及时且定期备份本地数据。
@ 修正一些已知的问题，优化代码。
```
...
`version 5.0.20220423.2` 【🔥 [安装脚本](https://github.com/F9y4ng/GreasyFork-Scripts/raw/master/Google%20%26%20Baidu%20Switcher.user.js)】
