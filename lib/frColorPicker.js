...
(function (n, z) {
  ...
  var z = (function () {
    ...
    a: {
      try {
        n.addEventListener("testPassive", null, { passive: !0 }), n.removeEventListener("testPassive", null, { passive: !0 });
      } catch (b) {
        x = !1;
        break a;
      }
    ...
    var a = {
      ...
      node: function (b) {
        ...
        if ("string" === typeof b) {
          var d = null;
          try {
            d = n.document.querySelector(b) || A.querySelector(b);
          } catch (e) {
            return null;
          }
          return d;
      ...
      setStyle: function (b, d, e, g) {
        ...
        for (l in d)
          if (a.hOP.call(d, l)) {
            var p = null;
            null === d[l]
              ? (k || (k = a.getData(b, "origStyle")), k && a.hOP.call(k, l) && (p = k[l]))
              : (g && (k || (k = a.getData(b, "origStyle", {})), a.hOP.call(k, l) || (k[l] = b.style[l])), (p = d[l]));
            null !== p && b.style.setProperty(l, p, e);
          }
      },
      ...
      parseColorString: function (b) {
        ...
        if ((e = b.match(/^\W*([0-9A-F]{3,8})\W*$|^currentcolor$/i))) {
          ...
          else if (4 === e[1].length)
            (d.format = "hexa"),
              (d.rgba = [
                parseInt(e[1].charAt(0) + e[1].charAt(0), 16),
                parseInt(e[1].charAt(1) + e[1].charAt(1), 16),
                parseInt(e[1].charAt(2) + e[1].charAt(2), 16),
                parseInt(e[1].charAt(3) + e[1].charAt(3), 16) / 255,
              ]);
        ...
        if ((e = b.match(/^\W*rgba?\(([^)]*)\)\W*$/i))) {
          ...
          if (3 <= b.length && (g = b[0].match(e)) && (k = b[1].match(e)) && (l = b[2].match(e)))
            return (
              ...
              4 <= b.length && (p = b[3].match(e)) && ((d.format = "rgba"), (d.rgba[3] = parseFloat(p[1]) || 0)),
              d
            );
        }
        return !1;
      ...
      genColorPreviewCanvas: function (b, d, e, g) {
        ...
        t.fillRect(0, 0, e, m);
        t.fillStyle = p;
        for (g = 0; g < e; g += 2 * k) t.fillRect(g, 0, k, k), t.fillRect(g + k, k, k, k);
      ...
      redrawPosition: function () {
        if (a.picker && a.picker.owner) {
          ...
          d = b.smartPosition
            ? [
                -e[l] + d[l] + p[l] > k[l] ? (-e[l] + d[l] + g[l] / 2 > k[l] / 2 && 0 <= d[l] + g[l] - p[l] ? d[l] + g[l] - p[l] : d[l]) : d[l],
                -e[m] + d[m] + g[m] + p[m] - t + t * u > k[m]
                  ? -e[m] + d[m] + g[m] / 2 > k[m] / 2 && 0 <= d[m] + g[m] - t - t * u
                    ? d[m] + g[m] - t - t * u - 4
                    : d[m] + g[m] - t + t * u + 4
                  : 0 <= d[m] + g[m] - t + t * u
                  ? d[m] + g[m] - t + t * u - 4
        ...
        b.frcp && b.frcp instanceof a.pub
          ? b.frcp.showOnClick &&
            ...
            (a.picker && a.picker.owner
              ? (a.picker.owner.tryHide(), n.document.removeEventListener("mousedown", a.onDocumentMouseDown, !1))
              : (b.frcp.show(), n.document.addEventListener("mousedown", a.onDocumentMouseDown, !1)))
          : a.picker && a.picker.owner && (a.picker.owner.tryHide(), n.document.removeEventListener("mousedown", a.onDocumentMouseDown, !1));
      },
      onDocumentMouseDown: function (b) {
        if (!b.target || !b.target.nodeName || "fr-configure" !== b.target.nodeName.toLowerCase()) {
          ...
          } else a.picker && a.picker.owner && (a.picker.owner.tryHide(), n.document.removeEventListener("mousedown", a.onDocumentMouseDown, !1));
        }
      },
      ...
      onControlPointerStart: function (b, d, e, g) {
        ...
        a.preventDefault(b);
        var l = function (u, t) {
          a.attachGroupEvent("drag", u, a._pointerMoveEvent[g], a.onDocumentPointerMove(b, d, e, g, t));
          a.attachGroupEvent("drag", u, a._pointerEndEvent[g], a.onDocumentPointerEnd(b, d, e, g));
        };
        l(n.document, [0, 0]);
        ...
        p = a.getRelPointerPos(b);
        a._pointerOrigin = { x: l.x - p.x, y: l.y - p.y };
        switch (e) {
          case "pad":
      ...
      onDocumentPointerMove: function (b, d, e, g, k) {
        return function (l) {
          var p = a.getData(d, "instance");
          switch (e) {
            case "pad":
              a.setPad(p, l, k[0], k[1]);
              break;
            case "sld":
              a.setSld(p, l, k[1]);
              break;
      ...
      createASliderGradient: function () {
        ...
        b.draw = function (g, k, l) {
          ...
          e.fillRect(0, 0, d.width, d.height);
          if (0 < g) for (var p = 0; p < d.height; p += 2 * g) (e.fillStyle = k), e.fillRect(0, p, g, g), e.fillRect(g, p + g, g, g);
          g = e.createLinearGradient(0, 0, 0, d.height);
          g.addColorStop(0, l);
      ...
      pub: function (b, d, e) {
        ...
        function k() {
          ...
          var c = a.picker,
            ...
            H = Math.min(f.borderRadius, Math.round(f.padding * Math.PI)),
            B = f.padding + f.width + 2 * f.controlBorderWidth + w + (h ? f.sliderSize + 2 * w + 2 * f.controlBorderWidth : 0);
          c.wrap.className = E;
          ...
          c.sldM.style.width = f.sliderSize + 2 * w + 2 * f.controlBorderWidth + (q ? 0 : Math.max(0, f.padding - w)) + "px";
        ...
        A = d;
        A.addEventListener("click", a.onConfigIfMouseDown, !1);
        var f = this;
        e || (e = {});
        this.scrollbar = A.querySelector("fr-scrollbar");
        ...
        this.fromHSVA = function (c, h, q, r, v) {
          ...
          if (null !== q) {
            if (isNaN(q)) return !1;
            this.channels.v = Math.max(0, Math.min(100, this.maxV, q), this.minV);
          }
          if (null !== r) {
            if (isNaN(r)) return !1;
        ...
        this.fromRGBA = function (c, h, q, r, v) {
          "undefined" === typeof c && (c = null);
          "undefined" === typeof h && (h = null);
          "undefined" === typeof q && (q = null);
          "undefined" === typeof r && (r = null);
          ...
          c = a.RGB_HSV(null === c ? this.channels.r : c, null === h ? this.channels.g : h, null === q ? this.channels.b : q);
        ...
        this.hide = function () {
          this.scrollbar && this.scrollbar.removeEventListener("scroll", a.onWindowScroll, !1);
          u() &&
        ...
        this.show = function () {
          k();
          this.scrollbar && this.scrollbar.addEventListener("scroll", a.onWindowScroll, !1);
        };
        ...
        this.exposeColor = function (c) {
          ...
          if (!(c & a.flags.leaveValue) && this.valueElement) {
            if ("hex" === q || "hexa" === q) this.uppercase || (h = h.toLowerCase()), this.hash || (h = h.replace(/^#/, ""));
        ...
        this.setPreviewElementBg = function (c) {
          if (this.previewElement) {
            var h = null,
              q = null;
            a.isTextInput(this.previewElement) && ((h = this.previewPosition), (q = this.previewSize));
            var r = [];
            r.push({ size: "auto" });
            if (c) {
              var v = a.genColorPreviewCanvas("rgba(0,0,0,0)", h ? { left: "right", right: "left" }[h] : null, q, !0);
              r.push({ size: v.width + "px " + v.height + "px" });
            }
            v = [];
            for (var w = 0; w < r.length; w += 1) v.push(r[w].size);
            c = {
              "--fr-input-color": c,
        ...
        if (a.pub.options)
          for (var y in a.pub.options)
            if (a.hOP.call(a.pub.options, y))
              try {
                g(y, a.pub.options[y]);
              } catch (c) {
                console.error(c);
        ...
        this.container = "undefined" === typeof this.container ? n.document.documentElement : a.node(this.container);
        ...
        this.valueElement &&
          ...
          this.valueElement.addEventListener("input", I, !1),
        ...
        -1 < ["auto", "any"].indexOf(this.format.toLowerCase()) ? (this._currentFormat = (d = a.parseColorString(b)) ? d.format : "hex") : (this._currentFormat = this.format.toLowerCase());
        this.processValueInput(b);
      },
    };
    a.pub.className = C;
    a.pub.activeClassName = D;
    a.pub.looseJSON = !0;
