    ...
    E = (function () {
      ...
      var b = {
        ...
        _drawPosition: function (a, c, d) {
          b.picker.wrap.style.cssText = "--l:" + a + "px;--t:" + c + "px;--pos:" + d + ";";
        },
        ...
        pub: function (a, c, d) {
          ...
          function h() {
            ...
            m += "width:" + Number(f.padding + 2 * f.controlBorderWidth + f.width + C) + "px;";
            m += "height:" + Number(2 * f.controlBorderWidth + 2 * f.padding + f.height) + "px;cursor:crosshair}";
            ...
            m += "height:" + Number(2 * f.pointerBorderWidth + f.pointerThickness) + "px;width:" + y + "px;";
            m += "top:" + Number(Math.floor(y / 2) - Math.floor(f.pointerThickness / 2) - f.pointerBorderWidth) + "px;left:0}";
            e.crossBY.className = N;
            m += "." + u(N) + "{position:absolute;background:" + f.pointerBorderColor + "!important;";
            m += "width:" + Number(2 * f.pointerBorderWidth + f.pointerThickness) + "px;height:" + y + "px;";
            m += "left:" + Number(Math.floor(y / 2) - Math.floor(f.pointerThickness / 2) - f.pointerBorderWidth) + "px;top:0}";
            e.crossLX.className = O;
            m += "." + u(O) + "{position:absolute;background:" + f.pointerColor + "!important;";
            m += "height:" + f.pointerThickness + "px;width:" + Number(y - 2 * f.pointerBorderWidth) + "px;";
            m += "left:" + f.pointerBorderWidth + "px;top:" + Number(Math.floor(y / 2) - Math.floor(f.pointerThickness / 2)) + "px}";
            e.crossLY.className = P;
            m += "." + u(P) + "{position:absolute;background:" + f.pointerColor + "!important;";
            m += "width:" + f.pointerThickness + "px;height:" + Number(y - 2 * f.pointerBorderWidth) + "px;";
            m += "top:" + f.pointerBorderWidth + "px;left:" + Number(Math.floor(y / 2) - Math.floor(f.pointerThickness / 2)) + "px}";
            e.sld.className = Q;
            ...
            m += "left:" + Number(f.padding + f.width + 2 * f.controlBorderWidth + 2 * C) + "px;";
            ...
            m += "left:" + Number(f.padding + f.width + 2 * f.controlBorderWidth + C) + "px;";
            m += "top:0px;width:" + Number(f.sliderSize + 2 * C + 2 * f.controlBorderWidth) + "px;";
            m += "height:" + Number(2 * f.controlBorderWidth + 2 * f.padding + f.height) + "px;cursor:default}";
            ...
            m += "left:" + ia + "px;top:0px;width:" + Number(f.sliderSize + 2 * C + 2 * f.controlBorderWidth) + "px;";
            m += "height:" + Number(2 * f.controlBorderWidth + 2 * f.padding + f.height) + "px;cursor:default}";
          ...
          function l() {
            var e = b.getPadYChannel(f),
              k = -Math.floor((2 * f.pointerBorderWidth + f.pointerThickness + 2 * f.crossSize) / 2);
            b.picker.cross.style.cssText =
              "--cl:" + Number(Math.round((f.channels.h / 360) * (f.width - 1)) + k) + "px;--ct:" + Number(Math.round((1 - f.channels[e] / 100) * (f.height - 1)) + k) + "px";
          ...
          function p() {
            ...
            e &&
              (b.picker.sldPtrOB.style.cssText =
                "--st:" + Number(Math.round((1 - f.channels[e] / 100) * (f.height - 1)) - (2 * f.pointerBorderWidth + f.pointerThickness) - Math.floor(b.pub.sliderInnerSpace / 2)) + "px");
            b.picker.asldGrad.draw(f.sliderSize, f.height, f.toHEXString());
          }
          function n() {
            b.picker.asldPtrOB.style.cssText =
              "--at:" + Number(Math.round((1 - f.channels.a) * (f.height - 1)) - (2 * f.pointerBorderWidth + f.pointerThickness) - Math.floor(b.pub.sliderInnerSpace / 2)) + "px";
          }
          function x() {
