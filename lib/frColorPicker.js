      ...
      try {
        ...
        try {
          if (!A.querySelector("style#" + u)) {
            ...
            Object.assign(B, { id: u, media: "all", type: "text/css", textContent: D });
            A.prepend(B);
          }
        } catch (F) {
    ...
    E = (function () {
      ...
      var b = {
        ...
        genColorPreviewCanvas: function (a, c, d, g) {
          ...
          d = d ? d : 2 * h;
          var n = 2 * h, x = b.createEl("canvas"), w = x.getContext("2d");
          x.width = d;
          x.height = n;
        ...
        pub: function (a, c, d) {
          ...
          function h() {
            ...
            var e = b.picker, k = !!b.getSliderChannel(f), r = f.hasAlphaChannel(), t = b.getPickerDims(f), C = b.getControlPadding(f);
            var y = 2 * f.pointerBorderWidth + f.pointerThickness + 2 * f.crossSize, ma = Math.min(f.borderRadius, Math.round(f.padding * Math.PI));
            var ia = f.padding + f.width + 2 * f.controlBorderWidth + C + (k ? f.sliderSize + 2 * C + 2 * f.controlBorderWidth : 0);
            e.wrap.className = J;
            var m = ":host(." + u(J) + "){position:var(--pos,absolute);left:var(--l,0);top:var(--t,0);";
            ...
            e.box.className = K;
            m += "." + u(K) + "{box-sizing:border-box;width:" + t.paddedW + "px;height:" + t.paddedH + "px;position:relative} ";
            e.boxB.className = L;
            m += "." + u(L) + " {box-sizing:border-box;position:relative;border:" + f.borderWidth + "px solid " + f.borderColor + "!important;";
            m += "background:" + f.backgroundColor + "!important;border-radius:" + ma + "px} ";
            e.pad.className = la;
            m += "." + u(la) + "{width:" + f.width + "px;height:" + f.height + "px}";
            e.padCanvas.draw(f.width, f.height, b.getPadYChannel(f));
            e.padB.id = G;
            m += "#" + u(G) + "{position:absolute;left:" + f.padding + "px;top:" + f.padding + "px;";
            m += "width:" + f.width + "px;height:" + f.height + "px;border:" + f.controlBorderWidth + "px solid " + f.controlBorderColor + "!important}";
            e.padM.id = ba;
            ...
            e.cross.className = M;
            m += "." + u(M) + "{position:absolute;left:var(--cl,0);top:var(--ct,0);width:" + y + "px;height:" + y + "px}";
            ...
            e.sld.className = R;
            m += "." + u(R) + "{overflow:hidden;width:" + f.sliderSize + "px;height:" + f.height + "px}";
            ...
            m += "." + u(S) + "{border:" + f.pointerBorderWidth + "px solid " + f.pointerBorderColor + "!important}";
            e.sldPtrOB.className = T;
            m += "." + u(T) + "{position:absolute;border:" + f.pointerBorderWidth + "px solid " + f.pointerBorderColor + "!important;";
            m += "top:var(--st,0);left:" + -(2 * f.pointerBorderWidth + f.pointerThickness) + "px}";
            e.sldPtrMB.className = U;
            m += "." + u(U) + "{border:" + f.pointerThickness + "px solid " + f.pointerColor + "!important}";
            e.sldPtrS.className = V;
            m += "." + u(V) + "{width:" + f.sliderSize + "px;height:" + b.pub.sliderInnerSpace + "px}";
            e.asld.className = W;
            m += "." + u(W) + "{overflow:hidden;width:" + f.sliderSize + "px;height:" + f.height + "px}";
            ...
            m += "." + u(Z) + "{border:" + f.pointerThickness + "px solid " + f.pointerColor + "!important}";
            e.asldPtrS.className = aa;
            m += "." + u(aa) + "{width:" + f.sliderSize + "px;height:" + b.pub.sliderInnerSpace + "px}";
          ...
          function p() {
            ...
            var az = "--st:" + parseInt(Math.round((1 - f.channels[e] / 100) * (f.height - 1)) - (2 * f.pointerBorderWidth + f.pointerThickness) - Math.floor(b.pub.sliderInnerSpace / 2)) + "px";
            e && (b.picker.sldPtrOB.style.cssText = az);
            b.picker.asldGrad.draw(f.sliderSize, f.height, f.toHEXString());
          }
          function n() {
