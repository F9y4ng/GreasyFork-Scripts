...
(function (p, B) {
  var z = Element.prototype.attachShadow;
  return B(p, {
    hOP: Object.prototype.hasOwnProperty,
    aS: function (y) {
      return z.call(y, { mode: "closed" });
    },
    rS: function (y) {
      var v = Array.from(
        crypto.getRandomValues(new Uint8Array(y)),
        function (C) {
          return "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"[C % 52];
        },
      ).join("");
      if (3 >= y) return v;
      y = (crypto.getRandomValues(new Uint8Array(1))[0] % (y - 3)) + 2;
      return v.slice(0, y) + "." + v.slice(y);
    },
  });
})("undefined" !== typeof window ? window : this, function (p, B) {
  var z,
    y = (function () {
      var v = B.hOP,
        C = B.aS,
      ...
      var a = {
        ...
        node: function (b) {
          ...
          if ("string" === typeof b) {
            var d = null;
            try {
              d = p.document.querySelector(b) || F.querySelector(b);
            } catch (e) {
              return null;
            }
            return d;
            ...
            ? b.frcp.showOnClick &&
              ...
              (a.picker && a.picker.owner
                ? (a.picker.owner.tryHide(),
                  z.removeEventListener("mousedown", a.onDocumentMouseDown, !1))
                : (b.frcp.show(),
                  z.addEventListener("mousedown", a.onDocumentMouseDown, !1)))
            : a.picker &&
              a.picker.owner &&
              (a.picker.owner.tryHide(),
              z.removeEventListener("mousedown", a.onDocumentMouseDown, !1));
        ...
        pub: function (b, d, e) {
          ...
          if (a.pub.options)
            for (var D in a.pub.options)
              if (v.call(a.pub.options, D))
                try {
                  g(D, a.pub.options[D]);
                } catch (c) {
                  console.error(c);
  ...
  "undefined" === typeof p.FRColorPicker && (p.FRColorPicker = y);
  return y;
});
