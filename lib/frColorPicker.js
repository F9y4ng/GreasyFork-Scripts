...
(function (q, A) {
  return A(
    ...
    function (B, E, u) {
      try {
        ...
        var w = (function (z, F, G) {
          z = ":host(sheet-metadata){--sheet-metadata:" + JSON.stringify({ id: z }) + "}";
          return (G = new CSSStyleSheet()), G.media.appendMedium("all"), G.replaceSync(F), G.insertRule(z, 0), G;
        })(u, E, null);
        !Array.from(B.adoptedStyleSheets).some(function (z) {
          ...
          return z.id === u;
        }) && B.adoptedStyleSheets.push(w);
      } catch (z) {
        try {
          if (!B.querySelector("style#" + u)) {
            var C = document.createElement("style");
            Object.assign(C, { id: u, media: "all", type: "text/css", textContent: E });
            B.prepend(C);
          }
        } catch (F) {
          console.error(F.name + "in UAS: " + F.message + "(" + z.message + ")");
        }
      }
    },
    function (B) {
    ...
    function (B) {
      var E = Array.from(crypto.getRandomValues(new Uint8Array(B)), function (u) {
...
})("undefined" !== typeof window ? window : this, function (q, A, B, E, u, w) {
  var C,
    z = (function () {
      var F = null, G = w(9), ka = w(8), K = w(12), L = w(8), M = w(7), la = w(8), N = w(8), O = w(7);
      var P = w(7), Q = w(7), R = w(7), S = w(8), T = w(7), U = w(7), V = w(7), W = w(7), X = w(7);
      var Y = w(7), Z = w(7), aa = w(7), ba = w(7), H = w(8), ca = w(8), da = w(8), ea = w(8), fa = w(8), ha = w(8);
      a: {
        try {
      ...
      var b = {
        ...
        setStyle: function (a, c, d, g) {
          ...
          for (l in c)
            if (A.call(c, l)) {
              var p = null;
              null === c[l]
                ? (h || (h = b.getData(a, "origStyle")), h && A.call(h, l) && (p = h[l]))
                : (g && (h || (h = b.getData(a, "origStyle", {})), A.call(h, l) || (h[l] = a.style[l])), (p = c[l]));
        ...
        genColorPreviewCanvas: function (a, c, d, g) {
          var h = b.pub.chessboardSize, l = b.pub.chessboardColor1, p = b.pub.chessboardColor2;
          d = d ? d : 2 * h;
          var n = 2 * h, x = b.createEl("canvas"), v = x.getContext("2d");
          x.width = d;
          x.height = n;
          ...
          v.fillRect(0, 0, d, n);
          v.fillStyle = p;
          for (g = 0; g < d; g += 2 * h) v.fillRect(g, 0, h, h), v.fillRect(g + h, h, h, h);
          a && ((v.fillStyle = a), v.fillRect(0, 0, d, n));
          switch (c) {
            case "left":
              v.clearRect(0, 0, 0, n);
              break;
            case "right":
              v.clearRect(d - 0, 0, 0, n);
          }
        ...
        redrawPosition: function () {
          if (b.picker && b.picker.owner) {
            ...
            var g = b.getElementSize(a.targetElement), h = b.getViewSize(), l = b.getPickerDims(a), p = [l.borderW, l.borderH];
            ...
            c = a.smartPosition
              ? [
                  ...
                  -d[n] + c[n] + g[n] + p[n] - v + v * x > h[n]
                    ? -d[n] + c[n] + g[n] / 2 > h[n] / 2 && 0 <= c[n] + g[n] - v - v * x
                      ? c[n] + g[n] - v - v * x - 4
                      : c[n] + g[n] - v + v * x + 4
                    : 0 <= c[n] + g[n] - v + v * x
                    ? c[n] + g[n] - v + v * x - 4
        ...
        onControlPointerStart: function (a, c, d, g) {
          ...
          b.preventDefault(a);
          var l = function (x, v) {
            b.attachGroupEvent("drag", x, b._pointerMoveEvent[g], b.onDocumentPointerMove(a, c, d, g, v));
        ...
        pub: function (a, c, d) {
          ...
          function h() {
            ...
            b.picker ||
              ...
              C.addEventListener("touchstart", b.onPickerTouchStart, b.isPassiveEventSupported ? { passive: !1 } : !1));
            var e = b.picker, k = !!b.getSliderChannel(f), r = f.hasAlphaChannel(), t = b.getPickerDims(f), D = b.getControlPadding(f);
            var y = 2 * f.pointerBorderWidth + f.pointerThickness + 2 * f.crossSize, ma = Math.min(f.borderRadius, Math.round(f.padding * Math.PI));
            var ja = f.padding + f.width + 2 * f.controlBorderWidth + D + (k ? f.sliderSize + 2 * D + 2 * f.controlBorderWidth : 0);
            e.wrap.className = K;
            var m = ":host(." + u(K) + "){position:var(--pos,absolute);left:var(--l,0);top:var(--t,0);";
            m = m + "box-sizing:border-box;display:block!important;visibility:visible!important;opacity:1!important;clear:both!important;";
            m = m + "width:"+ t.borderW + "px;height:" + t.borderH + "px;z-index:" + f.zIndex + "!important}";
            e.box.className = L;
            m += "." + u(L) + "{box-sizing:border-box;width:" + t.paddedW + "px;height:" + t.paddedH + "px;position:relative} ";
            e.boxB.className = M;
            m += "." + u(M) + " {box-sizing:border-box;position:relative;border:" + f.borderWidth + "px solid " + f.borderColor + "!important;";
            m += "background:" + f.backgroundColor + "!important;border-radius:" + ma + "px} ";
            e.pad.className = la;
            e.padCanvas.draw(f.width, f.height, b.getPadYChannel(f));
            e.padB.id = H;
            m += "#" + u(H) + "{position:absolute;left:" + f.padding + "px;top:" + f.padding + "px}";
            m += "#" + u(H) + " canvas{border:" + f.controlBorderWidth + "px solid " + f.controlBorderColor + "!important}";
            e.padM.id = ca;
            m += "#" + u(ca) + "{position:absolute;left:0px;top:0px;";
            ...
            e.cross.className = N;
            m += "." + u(N) + "{position:absolute;left:var(--cl,0);top:var(--ct,0);width:" + y + "px;height:" + y + "px}";
            e.crossBX.className = O;
            m += "." + u(O) + "{position:absolute;background:" + f.pointerBorderColor + "!important;";
            ...
            e.crossBY.className = P;
            m += "." + u(P) + "{position:absolute;background:" + f.pointerBorderColor + "!important;";
            ...
            e.crossLX.className = Q;
            m += "." + u(Q) + "{position:absolute;background:" + f.pointerColor + "!important;";
            ...
            e.crossLY.className = R;
            m += "." + u(R) + "{position:absolute;background:" + f.pointerColor + "!important;";
            ...
            e.sld.className = S;
            m += "." + u(S) + "{overflow:hidden;width:" + f.sliderSize + "px;height:" + f.height + "px}";
            ...
            e.sldM.id = ea;
            m += "#" + u(ea) + "{display:" + (k ? "block" : "none") + ";position:absolute;";
            ...
            e.sldPtrIB.className = T;
            m += "." + u(T) + "{border:" + f.pointerBorderWidth + "px solid " + f.pointerBorderColor + "!important}";
            e.sldPtrOB.className = U;
            m += "." + u(U) + "{position:absolute;border:" + f.pointerBorderWidth + "px solid " + f.pointerBorderColor + "!important;";
            m += "top:var(--st,0);left:" + -(2 * f.pointerBorderWidth + f.pointerThickness) + "px}";
            e.sldPtrMB.className = V;
            m += "." + u(V) + "{border:" + f.pointerThickness + "px solid " + f.pointerColor + "!important}";
            e.sldPtrS.className = W;
            m += "." + u(W) + "{width:" + f.sliderSize + "px;height:" + b.pub.sliderInnerSpace + "px}";
            e.asld.className = X;
            m += "." + u(X) + "{overflow:hidden;width:" + f.sliderSize + "px;height:" + f.height + "px}";
            e.asldGrad.draw(f.sliderSize, f.height, "#000");
            e.asldB.id = fa;
            m += "#" + u(fa) + "{display:" + (r ? "block" : "none") + ";position:absolute;left:" + ja + "px;";
            m += "top:" + f.padding + "px;border:" + f.controlBorderWidth + "px solid " + f.controlBorderColor + "!important}";
            e.asldM.id = ha;
            m += "#" + u(ha) + "{display:" + (r ? "block" : "none") + ";position:absolute;";
            m += "left:" + ja + "px;top:0px;width:" + parseInt(f.sliderSize + 2 * D + 2 * f.controlBorderWidth) + "px;";
            m += "height:" + parseInt(2 * f.controlBorderWidth + 2 * f.padding + f.height) + "px;cursor:default}";
            b.setData(e.asldM, { instance: f, control: "asld" });
            e.asldPtrIB.className = Y;
            m += "." + u(Y) + "{border:" + f.pointerBorderWidth + "px solid " + f.pointerBorderColor + "!important}";
            e.asldPtrOB.className = Z;
            m += "." + u(Z) + "{border:" + f.pointerBorderWidth + "px solid " + f.pointerBorderColor + "!important;";
            m += "position:absolute;top:var(--at,0);left:" + -(2 * f.pointerBorderWidth + f.pointerThickness) + "px}";
            e.asldPtrMB.className = aa;
            m += "." + u(aa) + "{border:" + f.pointerThickness + "px solid " + f.pointerColor + "!important}";
            e.asldPtrS.className = ba;
            m += "." + u(ba) + "{width:" + f.sliderSize + "px;height:" + b.pub.sliderInnerSpace + "px}";
          ...
          function p() {
            ...
            var ez = "--st:" + parseInt(Math.round((1 - f.channels[e] / 100) * (f.height - 1)) - (2 * f.pointerBorderWidth + f.pointerThickness) - Math.floor(b.pub.sliderInnerSpace / 2)) + "px"
            e && (b.picker.sldPtrOB.style.cssText = ez);
            b.picker.asldGrad.draw(f.sliderSize, f.height, f.toHEXString());
          }
          function n() {
          ...
          this.setPreviewElementBg = function (e) {
            if (this.previewElement) {
              ...
              y = [];
              for (var D = 0; D < t.length; D += 1) y.push(t[D].size);
              e = {
                "--fr-input-color": e,
          ...
          if (b.pub.options)
            for (var I in b.pub.options)
              if (A.call(b.pub.options, I))
                try {
                  g(I, b.pub.options[I]);
                } catch (e) {
                  console.error(e);
          ...
          this.valueElement &&
            ...
            this.valueElement.addEventListener("change", v, !1),
  ...
  "undefined" === typeof q.FRColorPicker && (q.FRColorPicker = z);
  return z;
});
