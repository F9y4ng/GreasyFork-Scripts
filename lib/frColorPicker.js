...
!(function (p, F, C) {
  "object" === typeof module && "object" === typeof module.exports
    ? (module.exports = p.document
        ? F(p, C)
        : function (H) {
            if (!H.document) throw Error("No Document!");
            return F(H, C);
          })
    : F(p, C);
})(
  ...
  function (p, F) {
    ...
    var D = !isNaN(parseFloat(p.mozInnerScreenX)),
      ...
      K = (function () {
        var a = {
          ...
          register: function () {
            if ("undefined" !== typeof p && p.document) {
              var b = function () {
                "loading" !== p.document.readyState && p.document.body ? a.pub.init() : p.document.addEventListener("DOMContentLoaded", a.pub.init, !1);
                "complete" === p.document.readyState && p.document.removeEventListener("readystatechange", b);
              };
              p.document.addEventListener("readystatechange", b);
            }
          },
          installBySelector: function (b, d) {
            d = d ? a.node(d) : p.document;
          ...
          getCompStyle: function (b) {
            return (b = p.getComputedStyle ? p.getComputedStyle(b) : b.currentStyle) ? b : {};
          },
          ...
          _drawPosition: function (b, d, e, g, h) {
            ...
            D &&
              l &&
              1 !== l &&
              ((a.picker.wrap.style.left = d / l - L.getBoundingClientRect().left + "px"), (a.picker.wrap.style.top = e / l - L.getBoundingClientRect().top + "px"));
          ...
          onControlPointerStart: function (b, d, e, g) {
            ...
            if (p.parent && p.frameElement) {
              ...
              l(p.parent.window.document, D ? [-r.left * m, -r.top * m] : [-r.left, -r.top]);
            }
          ...
          pub: function (b, d) {
            ...
            function g() {
              ...
              c.sldM.style.width = f.sliderSize + 2 * x + 2 * f.controlBorderWidth + (n ? 0 : Math.max(0, f.padding - x)) + "px";
              ...
              c.pal.className = R;
              c.pal.style.display = q.palette.rows ? "block" : "none";
              ...
              for (t = n = 0; t < q.palette.rows; t++)
                for (x = 0; x < q.palette.cols && n < f._palette.length; x++, n++) {
                  A = f._palette[n];
                  var y = a.rgbaColor.apply(null, A.rgba);
                  w = a.createEl("div");
                  w.style.width = q.palette.cellW - 2 * f.controlBorderWidth + "px";
                  w.style.height = q.palette.cellH - 2 * f.controlBorderWidth + "px";
                  w.style.backgroundColor = y;
                  y = a.createEl("div");
                  y.className = S;
                  y.style.display = "block";
                  y.style.position = "absolute";
                  y.style.left = (1 >= q.palette.cols ? 0 : Math.round(((q.contentW - q.palette.cellW) / (q.palette.cols - 1)) * 10 * x) / 10) + "px";
                  y.style.top = t * (q.palette.cellH + f.paletteSpacing) + "px";
              ...
              c.btn.style.maxWidth = q.contentW - 2 * f.controlBorderWidth - 30 + "px";
              ...
              (function () {
                var G = f.controlBorderColor.split(/\s+/);
                c.btn.style.borderColor = 2 > G.length ? G[0] : G[1] + " " + G[0] + " " + G[0] + " " + G[1];
              })();
              ...
              c.btnT.textContent = "";
              c.btnT.appendChild(p.document.createTextNode(f.closeText));
              h();
              l();
              m();
            ...
            this.randomize = function (c, k, n, q, t, x, A, w) {
              void 0 === c && (c = 0);
              void 0 === k && (k = 100);
              void 0 === n && (n = 0);
              void 0 === q && (q = 100);
            ...
            this.setPreviewElementBg = function (c) {
              if (this.previewElement) {
                ...
                c = [];
                n = [];
                for (var x = [], A = [], w = 0; w < t.length; w += 1) q.push(t[w].image), c.push(t[w].position), n.push(t[w].size), x.push(t[w].repeat), A.push(t[w].origin);
                t = {
            ...
            for (var J = E.length - 1; 0 <= J; --J) {
              ...
              if (I && a.pub.presets.hasOwnProperty(I))
                for (B in a.pub.presets[I])
                  if (a.pub.presets[I].hasOwnProperty(B))
                    try {
                      e(B, a.pub.presets[I][B]);
                    } catch (c) {
                      console.error(c);
                    }
            }
            ...
            this.alphaElement &&
              ...
              this.alphaElement.addEventListener("change", U, !1),
              this.alphaElement.addEventListener("input", W, !1),
    ...
    "undefined" === typeof p.FRColorPicker && (p.FRColorPicker = p.frColorPicker = K);
    "undefined" !== typeof unsafeWindow && "undefined" === typeof unsafeWindow.FRColorPicker && (unsafeWindow.FRColorPicker = unsafeWindow.frColorPicker = K);
    return K;
  },
  {
