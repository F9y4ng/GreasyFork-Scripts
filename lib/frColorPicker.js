...
!(function (r, I) {
  ...
  r.self === r.top &&
    r.trustedTypes &&
    r.trustedTypes.createPolicy &&
    (I = r.trustedTypes.createPolicy(
      (function (a) {
        ...
        for (
          ...
          if (location.hostname.startsWith(b[d].host)) {
            a = b[d].policy;
            break;
          }
        return a;
  ...
  var H = "undefined" !== typeof unsafeWindow ? unsafeWindow : r,
    D = !isNaN(parseFloat(H.mozInnerScreenX)),
    ...
    K = (function () {
      var a = {
        ...
        readyQueue: [],
        register: function () {
          "undefined" !== typeof r && r.document && r.document.addEventListener("DOMContentLoaded", a.pub.init, !1);
        },
        installBySelector: function (b, d) {
          d = d ? a.node(d) : r.document;
        ...
        checkZoomRatio: function (b) {
          b = D
            ? (b = r.getComputedStyle(document.body, null).getPropertyValue("transform")) && "none" !== b
              ? Number(b.split(",")[3]) || 1
              : 1
            : Number(r.getComputedStyle(document.body, null).getPropertyValue("zoom")) || 1;
          return b;
        },
        ...
        isPassiveEventSupported: (function () {
          ...
          try {
            ...
            r.addEventListener("testPassive", null, d);
            r.removeEventListener("testPassive", null, d);
          } catch (e) {}
          return b;
        })(),
        isColorAttrSupported: (function () {
          var b = r.document.createElement("input");
        ...
        triggerEvent: function (b, d, e, g) {
          if (b) {
            ...
            else (h = r.document.createEvent("Event")), h.initEvent(d, e, g);
            if (!h) return !1;
        ...
        getCompStyle: function (b) {
          return (b = r.getComputedStyle ? r.getComputedStyle(b) : b.currentStyle) ? b : {};
        },
        ...
        linearGradient: (function () {
          var b = (function () {
            for (var d = ["", "-webkit-", "-moz-", "-o-", "-ms-"], e = r.document.createElement("div"), g = 0; g < d.length; g += 1) {
        ...
        getRelPointerPos: function (b) {
          ...
          return {
            x: g - (D ? d.left * e : d.left),
            y: h - (D ? d.top * e : d.top),
          };
        },
        getViewPos: function () {
          var b = r.document.documentElement;
          return [(r.pageXOffset || b.scrollLeft) - (b.clientLeft || 0), (r.pageYOffset || b.scrollTop) - (b.clientTop || 0)];
        },
        getViewSize: function () {
          var b = r.document.documentElement;
          return [r.innerWidth || b.clientWidth, r.innerHeight || b.clientHeight];
        },
          ...
          if (a.picker && a.picker.owner) {
            ...
            e = b.smartPosition
              ? [
                  ...
                  -e[q] + d[q] + g[q] + l[q] - u + u * v > h[q]
                    ? -e[q] + d[q] + g[q] / 2 > h[q] / 2 && 0 <= d[q] + g[q] - u - u * v
                      ? d[q] + g[q] - u - u * v - 4
                      : d[q] + g[q] - u + u * v + 4
                    : 0 <= d[q] + g[q] - u + u * v
                    ? d[q] + g[q] - u + u * v - 4
              ...
              : [d[n], d[q] + g[q] - u + u * v - 4];
            a._drawPosition(b, e[n], e[q], b.fixed ? "fixed" : "absolute", (e[0] + l[0] > d[0] || e[0] < d[0] + g[0]) && e[1] + l[1] < d[1] + g[1]);
          }
        },
        _drawPosition: function (b, d, e, g, h) {
          ...
          D &&
            l &&
            1 !== l &&
            ((a.picker.wrap.style.left = d / l - M.getBoundingClientRect().left + "px"), (a.picker.wrap.style.top = e / l - M.getBoundingClientRect().top + "px"));
        ...
        getPaletteDims: function (b, d) {
          ...
          return { cols: e, rows: g, cellW: h, cellH: l, width: d, height: n };
        },
        ...
        onWindowScroll: function (b) {
          D && 1 !== a.checkZoomRatio() ? a.picker && a.picker.owner && a.picker.owner.tryHide() : a.redrawPosition();
        },
        ...
        onControlPointerStart: function (b, d, e, g) {
          ...
          l(r.document, [0, 0]);
          if (r.parent && r.frameElement) {
            var n = a.checkZoomRatio(),
              q = r.frameElement.getBoundingClientRect();
            l(r.parent.window.document, D ? [-q.left * n, -q.top * n] : [-q.left, -q.top]);
          }
        ...
        pub: function (b, d) {
          ...
          function g() {
            ...
            for (t = p = 0; t < m.palette.rows; t++)
              for (x = 0; x < m.palette.cols && p < f._palette.length; x++, p++) {
                A = f._palette[p];
                var y = a.rgbaColor.apply(null, A.rgba);
                w = a.createEl("div");
            ...
            (function () {
              var F = f.controlBorderColor.split(/\s+/);
              c.btn.style.borderColor = 2 > F.length ? F[0] : F[1] + " " + F[0] + " " + F[0] + " " + F[1];
            })();
            ...
            c.btnT.textContent = "";
            c.btnT.appendChild(r.document.createTextNode(f.closeText));
            h();
            l();
            n();
            a.picker.owner && a.picker.owner !== f && a.removeClass(a.picker.owner.targetElement, a.pub.activeClassName);
            a.picker.owner = f;
            f.container === r.document.body ? a.redrawPosition() : a._drawPosition(f, 0, 0, "relative", !1);
          ...
          this.randomize = function (c, k, p, m, t, x, A, w) {
            void 0 === c && (c = 0);
            void 0 === k && (k = 100);
            void 0 === p && (p = 0);
            void 0 === m && (m = 100);
            ...
            this.fromHSVA(
              ...
              (100 * A + Math.floor(Math.random() * (100 * (w - A) + 1))) / 100
            );
          };
          ...
          this.setPreviewElementBg = function (c) {
            if (this.previewElement) {
              ...
              c = [];
              p = [];
              for (var t = [], x = [], A = [], w = 0; w < m.length; w += 1) c.push(m[w].image), p.push(m[w].position), t.push(m[w].size), x.push(m[w].repeat), A.push(m[w].origin);
              m = {
          ...
          this.setValueElementValue = function (c) {
            this.valueElement && ("input" === a.nodeName(this.valueElement) ? (this.valueElement.value = c) : (this.valueElement.innerHTML = I.createHTML(c)));
          };
          this.setAlphaElementValue = function (c) {
            this.alphaElement && ("input" === a.nodeName(this.alphaElement) ? (this.alphaElement.value = c) : (this.alphaElement.innerHTML = I.createHTML(c)));
          };
          ...
          var E = [];
          d.preset && ("string" === typeof d.preset ? (E = d.preset.split(/\s+/)) : Array.isArray(d.preset) ? (E = d.preset.slice()) : console.warn("Unrecognized value"));
          -1 === E.indexOf("default") && E.push("default");
          ...
          E = ["preset"];
          for (B in d)
            if (d.hasOwnProperty(B) && -1 === E.indexOf(B))
              try {
                e(B, d[B]);
              } catch (c) {
                console.error(c);
              }
          this.container = void 0 === this.container ? r.document.body : a.node(this.container);
          ...
          a.isButton(this.targetElement) &&
            ...
            a.isButtonEmpty(this.targetElement) &&
              ...
              this.targetElement.appendChild(r.document.createTextNode("\u00a0")),
          ...
          this.valueElement &&
            ...
            this.valueElement.addEventListener("input", W, !1),
          ...
          this.alphaElement &&
            ...
            this.alphaElement.addEventListener("change", V, !1),
            this.alphaElement.addEventListener("input", X, !1),
      ...
      a.pub.init = function () {
        if (!a.initialized)
          for (
            r.document.addEventListener("mousedown", a.onDocumentMouseDown, !1),
              r.document.addEventListener("keyup", a.onDocumentKeyUp, !1),
              r.addEventListener("resize", a.onWindowResize, !1),
              r.addEventListener("scroll", a.onWindowScroll, !1),
              a.pub.install(),
              a.initialized = !0;
            a.readyQueue.length;
  ...
  "undefined" === typeof r.FRColorPicker && (r.FRColorPicker = r.frColorPicker = K);
  "undefined" === typeof H.FRColorPicker && (H.FRColorPicker = H.frColorPicker = K);
  return K;
