  ...
  F(n, {
    ...
    uAS: function (z, v, x) {
      try {
        ...
        (B.id = x) && B.replaceSync(v);
        !Array.from(z.adoptedStyleSheets).some(function (C) {
          return C.id === x;
        }) && z.adoptedStyleSheets.push(B);
      } catch (C) {
        try {
          ...
          C && console.error(E.name + "in UAS:", E.message, C.message);
        }
      }
    },
  });
  ...
  var z = (function () {
    var v = F.hOP,
      x = function (b) {
        ...
        return (
          d.slice(0, b - 4).padEnd(b - 3, Math.random().toString(36).slice(2)) +
          "." +
          d.slice(-3)
        );
      },
    ...
    var a = {
      ...
      getCompStyle: function (b) {
        return b instanceof ShadowRoot
          ? {}
          : (b = n.getComputedStyle ? n.getComputedStyle(b) : b.currentStyle)
            ? b
            : {};
      },
      ...
      getViewPos: function () {
        ...
        return [
          (n.pageXOffset || b.scrollLeft) - (b.clientLeft || 0),
          (n.pageYOffset || b.scrollTop) - (b.clientTop || 0),
        ];
      },
      ...
      getControlPadding: function (b) {
        return Math.max(
          b.padding / 2,
          2 * b.pointerBorderWidth + b.pointerThickness - b.controlBorderWidth,
        );
      },
      ...
      onDocumentMouseDown: function (b) {
        if (
          !b.target ||
          !b.target.nodeName ||
          "fr-configure" !== b.target.nodeName.toLowerCase()
        ) {
      ...
      pub: function (b, d, e) {
        ...
        function k() {
          ...
          var c = a.picker,
            ...
            J = Math.min(f.borderRadius, Math.round(f.padding * Math.PI)),
            G =
              f.padding +
              f.width +
          ...
          a.picker.owner &&
            a.picker.owner !== f &&
            a.removeClass(a.picker.owner.targetElement, a.pub.activeClassName);
          a.picker.owner = f;
        ...
        this.hide = function () {
          this.scrollbar &&
            this.scrollbar.removeEventListener("scroll", a.onWindowScroll, !1);
          u() &&
        ...
        if (this.targetElement.frcp && this.targetElement.frcp instanceof a.pub)
        ...
        this.valueElement &&
          ...
          this.valueElement.addEventListener("input", K, !1),
