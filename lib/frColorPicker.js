      ...
      var F = x(9),
        ...
        b = {
          ...
          checkGeckoRatio: function (a) {
            a = void 0 === a ? 1 : a;
            isNaN(parseFloat(p.mozInnerScreenX)) || (a = (a = p.getComputedStyle(document.body, null).getPropertyValue("transform")) && "none" !== a ? Number(a.split(",")[3]) || 1 : 1);
            return a;
          },
          ...
          pub: function (a, d) {
            ...
            this.setPreviewElementBg = function (c) {
              if (this.previewElement) {
                var k = null,
                  n = null;
                if (b.isTextInput(this.previewElement) || (b.isButton(this.previewElement) && !b.isButtonEmpty(this.previewElement))) (k = this.previewPosition), (n = this.previewSize);
                var q = null,
                  t = [];
                if (c) {
                  t.push({
