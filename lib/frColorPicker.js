    ...
    var E = (function () {
      ...
      var F = x(9),
        ...
        a = {
          ...
          checkGeckoRatio: function (b) {
            b = void 0 === b ? 1 : b;
            isNaN(parseFloat(p.mozInnerScreenX)) || (b = (b = p.getComputedStyle(document.body, null).getPropertyValue("transform")) && "none" !== b ? Number(b.split(",")[3]) || 1 : 1);
            return b;
          },
          checkWebkitRatio: function (b) {
            b = void 0 === b ? 1 : b;
            isNaN(parseFloat(p.mozInnerScreenX)) && ((b = p.getComputedStyle(document.body, null).getPropertyValue("zoom")), (b = Number(b) || 1));
            return b;
          },
          ...
          getAbsPointerPos: function (b) {
            var d = a.checkGeckoRatio(),
              e = a.checkWebkitRatio(),
              g = 0,
              k = 0;
            "undefined" !== typeof b.changedTouches && b.changedTouches.length
              ? ((g = b.changedTouches[0].x * d * e), (k = b.changedTouches[0].y * d * e))
              : "number" === typeof b.x && ((g = b.x * d * e), (k = b.y * d * e));
            return { x: g, y: k };
          },
          getRelPointerPos: function (b) {
            var d = a.checkGeckoRatio(),
              e = a.checkWebkitRatio(),
              g = (b.target || b.srcElement).getBoundingClientRect(),
              k = 0,
              l = 0;
            "undefined" !== typeof b.changedTouches && b.changedTouches.length
              ? ((k = b.changedTouches[0].x * d * e), (l = b.changedTouches[0].y * d * e))
              : "number" === typeof b.x && ((k = b.x * d * e), (l = b.y * d * e));
            return { x: k - g.left * d, y: l - g.top * d };
          },
          getViewPos: function () {
