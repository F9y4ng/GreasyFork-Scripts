...
(function (q, F) {
  "object" === typeof module && "object" === typeof module.exports
    ? (module.exports = q.document
        ? F(q)
        : function (C) {
            if (!C.document) throw Error("No Window with document!");
            return F(C);
          })
    : F(q);
})("undefined" !== typeof window ? window : this, function (q, F) {
  function C(a) {
    var b = "",
  ...
  var D = !isNaN(parseFloat(q.mozInnerScreenX)),
    ...
    L = (function () {
      var a = {
        ...
        onWindowScroll: function (b) {
          D && a.checkZoomRatio() !== 1 ? a.picker && a.picker.owner && a.picker.owner.tryHide() : a.redrawPosition();
        },
        ...
        onControlPointerStart: function (b, d, e, g) {
          ...
          if (q.parent && q.frameElement) {
            ...
            l(q.parent.window.document, D ? [-r.left * n, -r.top * n] : [-r.left, -r.top]);
          }
        ...
        pub: function (b, d) {
          ...
          for (var I = E.length - 1; 0 <= I; --I) {
            ...
            if (H && a.pub.presets.hasOwnProperty(H))
              for (B in a.pub.presets[H])
                if (a.pub.presets[H].hasOwnProperty(B))
                  try {
                    e(B, a.pub.presets[H][B]);
                  } catch (c) {
                    console.error(c);
                  }
          }
  ...
  "undefined" === typeof q.FRColorPicker && (q.FRColorPicker = q.frColorPicker = L);
  return L;
});
