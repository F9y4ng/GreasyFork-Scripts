  ...
  var J = (function () {
    var a = {
      ...
      linearGradient: (function () {
        var b = (function () {
          for (var d = ["", "-webkit-", "-moz-", "-o-", "-ms-"], e = q.document.createElement("div"), g = 0; g < d.length; g += 1) {
            ...
            if (e.style) e.style.background = h + "(to right, rgba(0,0,0,0), rgba(0,0,0,0))";
      ...
      genColorPreviewCanvas: function (b, d, e, g) {
        ...
        b && ((z.fillStyle = b), z.fillRect(0, 0, e, w));
        b = null;
        switch (d) {
          case "left":
            b = 0;
            z.clearRect(0, 0, h / 2, w);
            break;
          case "right":
            (b = e - h), z.clearRect(e - h / 2, 0, h / 2, w);
        }
        if (null !== b)
          for (z.lineWidth = 1, d = 0; d < a.pub.previewSeparator.length; d += 1)
            z.beginPath(), (z.strokeStyle = a.pub.previewSeparator[d]), z.moveTo(0.5 + b + d, 0), z.lineTo(0.5 + b + d, w), z.stroke();
        return { canvas: u, width: e, height: w };
      },
        ...
        if (a.picker && a.picker.owner) {
          ...
          e = b.smartPosition
            ? [
                ...
                -e[r] + d[r] + g[r] + l[r] - u + u * w > h[r]
                  ? -e[r] + d[r] + g[r] / 2 > h[r] / 2 && 0 <= d[r] + g[r] - u - u * w
                    ? d[r] + g[r] - u - u * w - 4
                    : d[r] + g[r] - u + u * w + 4
                  : 0 <= d[r] + g[r] - u + u * w
                  ? d[r] + g[r] - u + u * w - 4
      ...
      onControlPointerStart: function (b, d, e, g) {
        ...
        a.preventDefault(b);
        var l = function (r, w) {
          a.attachGroupEvent("drag", r, a._pointerMoveEvent[g], a.onDocumentPointerMove(b, d, e, g, w));
      ...
      pub: function (b, d) {
        ...
        function g() {
          ...
          var y = Number(q.getComputedStyle(document.body, null).getPropertyValue("zoom")) || 1;
          c.wrap.className = L;
          ...
          c.wrap.style.zoom = y && 1 !== y ? 1 / y : null;
          c.box.className = M;
          ...
          for (t = p = 0; t < n.palette.rows; t++)
            for (x = 0; x < n.palette.cols && p < f._palette.length; x++, p++)
              (A = f._palette[p]),
                (y = a.rgbaColor.apply(null, A.rgba)),
                (v = a.createEl("div")),
                ...
                (y.style.left = (1 >= n.palette.cols ? 0 : Math.round(((n.contentW - n.palette.cellW) / (n.palette.cols - 1)) * 10 * x) / 10) + "px"),
                (y.style.top = t * (n.palette.cellH + f.paletteSpacing) + "px"),
                (y.style.border = f.controlBorderWidth + "px solid"),
                (y.style.borderColor = f.controlBorderColor),
                (y.style.cursor = "pointer"),
                null !== A.rgba[3] &&
                  1 > A.rgba[3] &&
                  ((y.style.backgroundImage = "url('" + k.canvas.toDataURL() + "')"), (y.style.backgroundRepeat = "repeat"), (y.style.backgroundPosition = "center center")),
                a.setData(y, {
                  instance: f,
        ...
        this.randomize = function (c, k, p, n, t, x, A, v) {
          void 0 === c && (c = 0);
          void 0 === k && (k = 100);
          void 0 === p && (p = 0);
          void 0 === n && (n = 100);
        ...
        this.setPreviewElementBg = function (c) {
          if (this.previewElement) {
            ...
            c = [];
            p = [];
            for (var t = [], x = [], A = [], v = 0; v < n.length; v += 1) c.push(n[v].image), p.push(n[v].position), t.push(n[v].size), x.push(n[v].repeat), A.push(n[v].origin);
            n = {
        ...
        var E = [];
        d.preset && ("string" === typeof d.preset ? (E = d.preset.split(/\s+/)) : Array.isArray(d.preset) ? (E = d.preset.slice()) : console.warn("Unrecognized preset value"));
        ...
        this.valueElement &&
          ...
          this.valueElement.addEventListener("keydown", w, !1),
