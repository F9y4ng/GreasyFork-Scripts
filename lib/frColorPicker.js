...
(function (n, A) {
    ...
    var a = {
      ...
      node: function (b) {
        ...
        if ("string" === typeof b) {
          var d = null;
          try {
            d = n.document.querySelector(b) || B.querySelector(b);
          } catch (e) {
            return null;
          }
          return d;
      ...
      triggerEvent: function (b, d, e, g) {
        if (b) {
          ...
          else (l = n.document.createEvent("Event")), l.initEvent(d, e, g);
          if (!l) return !1;
      ...
      setStyle: function (b, d, e, g) {
        ...
        for (k in d)
          if (a.hOP.call(d, k)) {
            var p = null;
            null === d[k]
              ? (l || (l = a.getData(b, "origStyle")), l && a.hOP.call(l, k) && (p = l[k]))
              : (g && (l || (l = a.getData(b, "origStyle", {})), a.hOP.call(l, k) || (l[k] = b.style[k])), (p = d[k]));
            null !== p && b.style.setProperty(k, p, e);
          }
      },
      ...
      redrawPosition: function () {
        if (a.picker && a.picker.owner) {
          ...
          d = b.smartPosition
            ? [
                -e[k] + d[k] + p[k] > l[k] ? (-e[k] + d[k] + g[k] / 2 > l[k] / 2 && 0 <= d[k] + g[k] - p[k] ? d[k] + g[k] - p[k] : d[k]) : d[k],
                -e[q] + d[q] + g[q] + p[q] - u + u * t > l[q]
      ...
      onControlPointerStart: function (b, d, e, g) {
        ...
        if (n.parent && n.frameElement) {
          ...
          p = p.toggle ? p.cur : 1;
          var q = n.frameElement.getBoundingClientRect();
          k(n.parent.window.document, [-q.left * p, -q.top * p]);
        }
        k = a.getAbsPointerPos(b);
        p = a.getRelPointerPos(b);
        a._pointerOrigin = { x: k.x - p.x, y: k.y - p.y };
        switch (e) {
          case "pad":
      ...
      createASliderGradient: function () {
        ...
        b.draw = function (g, l, k) {
          ...
          e.fillRect(0, 0, d.width, d.height);
          if (0 < g) for (var p = 0; p < d.height; p += 2 * g) (e.fillStyle = l), e.fillRect(0, p, g, g), e.fillRect(g, p + g, g, g);
          g = e.createLinearGradient(0, 0, 0, d.height);
          g.addColorStop(0, k);
      ...
      pub: function (b, d, e) {
        ...
        var f = this;
        e || (e = {});
        this.scrollbar = B.querySelector("fr-scrollbar");
  ...
  "undefined" === typeof n.FRColorPicker && (n.FRColorPicker = A);
  return A;
});
