...
(function (q, z) {
    ...
    function (A, D, u) {
      try {
        if (
          ...
          "function" !== typeof A.adoptedStyleSheets.push
        )
  ...
  var B,
    E = (function () {
      var F = null, ja = v(9), ka = v(8), J = v(12), K = v(8), L = v(7), la = v(8), M = v(8), N = v(7);
      var O = v(7), P = v(7), Q = v(7), R = v(8), S = v(7), T = v(7), U = v(7), V = v(7), W = v(7), X = v(7);
      var Y = v(7), Z = v(7), aa = v(7), G = v(8), ba = v(8), ca = v(8), da = v(8), ea = v(8), fa = v(8);
      a: {
        try {
          q.addEventListener("testPassive", null, { passive: !0 }),
            q.removeEventListener("testPassive", null, { passive: !0 });
        } catch (a) {
          var ha = !1;
          break a;
        }
      ...
      var b = {
        ...
        getInstances: function () {
          for (var a = [], c = 0; c < b.instances.length; c += 1)
            b.instances[c] &&
              b.instances[c].targetElement &&
              a.push(b.instances[c]);
          return a;
        },
        createEl: function (a) {
        ...
        setData: function () {
          ...
          if (3 === arguments.length)
            return (
              ((z.call(a, b.dataProp) ? a[b.dataProp] : (a[b.dataProp] = {}))[
                arguments[1]
              ] = arguments[2]),
              !0
            );
        ...
        triggerEvent: function (a, c, d, g) {
          if (a) {
            if ("function" === typeof Event)
              var h = new Event(c, { bubbles: d, cancelable: g });
        ...
        addClass: function (a, c) {
          ...
          if ("undefined" !== typeof a.classList)
            for (var d = 0; d < c.length; d += 1) a.classList.add(c[d]);
          else
        ...
        removeClass: function (a, c) {
          c = b.strList(c);
          if ("undefined" !== typeof a.classList)
            for (var d = 0; d < c.length; d += 1) a.classList.remove(c[d]);
          else
            for (d = 0; d < c.length; d += 1)
        ...
        getCompStyle: function (a) {
          return a instanceof ShadowRoot
            ? {}
            : (a = q.getComputedStyle ? q.getComputedStyle(a) : a.currentStyle)
              ? a
              : {};
        },
        setStyle: function (a, c, d, g) {
          ...
          for (l in c)
            if (z.call(c, l)) {
              var p = null;
              null === c[l]
                ? (h || (h = b.getData(a, "origStyle")),
                  h && z.call(h, l) && (p = h[l]))
                : (g &&
                    (h || (h = b.getData(a, "origStyle", {})),
                    z.call(h, l) || (h[l] = a.style[l])),
                  (p = c[l]));
        ...
        getAbsPointerPos: function (a) {
          ...
          "undefined" !== typeof a.changedTouches && a.changedTouches.length
            ? ((d = a.changedTouches[0].x * c.cur),
              (g = a.changedTouches[0].y * c.cur))
        ...
        getRelPointerPos: function (a) {
          ...
          var d = (a.target || a.srcElement).getBoundingClientRect(),
            ...
            l = 0;
          "undefined" !== typeof a.changedTouches && a.changedTouches.length
            ? ((h = a.changedTouches[0].x * c.cur),
              (l = a.changedTouches[0].y * c.cur))
        ...
        getViewPos: function () {
          ...
          return [
            (q.pageXOffset || a.scrollLeft) - (a.clientLeft || 0),
            (q.pageYOffset || a.scrollTop) - (a.clientTop || 0),
          ];
        },
        getViewSize: function () {
          var a = q.document.documentElement;
          return [
            q.innerWidth || a.clientWidth,
            q.innerHeight || a.clientHeight,
          ];
        },
          ...
          if ((c = a.match(/^\W*rgba?\(([^)]*)\)\W*$/i))) {
            ...
            if (
              ...
              return (
                ...
                4 <= a.length &&
                  (p = a[3].match(c)) &&
                  ((d.format = "rgba"), (d.rgba[3] = parseFloat(p[1]) || 0)),
                d
              );
          }
          return !1;
        ...
        genColorPreviewCanvas: function (a, c, d, g) {
          ...
          w.fillStyle = p;
          for (g = 0; g < d; g += 2 * h)
            w.fillRect(g, 0, h, h), w.fillRect(g + h, h, h, h);
        ...
        getControlPadding: function (a) {
          return Math.max(
            a.padding / 2,
            2 * a.pointerBorderWidth +
              a.pointerThickness -
              a.controlBorderWidth,
          );
        },
        ...
        triggerGlobal: function (a) {
          for (var c = b.getInstances(), d = 0; d < c.length; d += 1)
            c[d].trigger(a);
        },
            ...
            ? a.frcp.showOnClick &&
              ...
              (b.picker && b.picker.owner
                ? (b.picker.owner.tryHide(),
                  B.removeEventListener("mousedown", b.onDocumentMouseDown, !1))
                : (a.frcp.show(),
                  B.addEventListener("mousedown", b.onDocumentMouseDown, !1)))
            : b.picker &&
              b.picker.owner &&
              (b.picker.owner.tryHide(),
              B.removeEventListener("mousedown", b.onDocumentMouseDown, !1));
        ...
        onDocumentMouseDown: function (a) {
          ...
          if (!c || !c.nodeName || "fr-configure" !== c.nodeName.toLowerCase())
            if (b.getData(c, "gui")) {
              if (b.getData(c, "control"))
                b.onControlPointerStart(a, c, b.getData(c, "control"), "mouse");
            } else
              b.picker &&
                b.picker.owner &&
                (b.picker.owner.tryHide(),
        ...
        onPickerTouchStart: function (a) {
          var c = a.target || a.srcElement;
          if (b.getData(c, "control"))
            b.onControlPointerStart(a, c, b.getData(c, "control"), "touch");
        },
        onControlPointerStart: function (a, c, d, g) {
          ...
          var l = function (x, w) {
            b.attachGroupEvent(
              ...
              b.onDocumentPointerMove(a, c, d, g, w),
            );
            b.attachGroupEvent(
              "drag",
              x,
              b._pointerEndEvent[g],
              b.onDocumentPointerEnd(a, c, d, g),
            );
          };
          l(q.document, [0, 0]);
          ...
          switch (d) {
            case "pad":
              "v" === b.getSliderChannel(h) &&
                0 === h.channels.v &&
                h.fromHSVA(null, null, 100, null);
              b.setPad(h, a, 0, 0);
              break;
            case "sld":
              b.setSld(h, a, 0);
        ...
        setPad: function (a, c, d, g) {
          ...
          d =
            (360 / (a.width - 1)) *
            (d + c.x - b._pointerOrigin.x - a.padding - a.controlBorderWidth);
          g =
            100 -
            (100 / (a.height - 1)) *
              (g + c.y - b._pointerOrigin.y - a.padding - a.controlBorderWidth);
        ...
        setSld: function (a, c, d) {
          ...
          d =
            100 -
            (100 / (a.height - 1)) *
              (d + c.y - b._pointerOrigin.y - a.padding - a.controlBorderWidth);
        ...
        createASliderGradient: function () {
          ...
          a.draw = function (g, h, l) {
            ...
            d.fillRect(0, 0, c.width, c.height);
            if (0 < g)
              for (var p = 0; p < c.height; p += 2 * g)
                (d.fillStyle = h),
                  d.fillRect(0, p, g, g),
                  d.fillRect(g, p + g, g, g);
            g = d.createLinearGradient(0, 0, 0, c.height);
            g.addColorStop(0, l);
        ...
        pub: function (a, c, d) {
          function g(e, k) {
            if ("string" !== typeof e)
              throw Error("Invalid value for option name: " + e);
            if (
              z.call(b.enumOpts, e) &&
              ("string" === typeof k && (k = k.toLowerCase()),
              -1 === b.enumOpts[e].indexOf(k))
            )
              throw Error("Option '" + e + "' has invalid value: " + k);
          ...
          function h() {
            ...
            var e = b.picker,
              ...
              ia =
                ...
                C +
                (k ? f.sliderSize + 2 * C + 2 * f.controlBorderWidth : 0);
            e.wrap.className = J;
            var m =
              ":host(." +
              u(J) +
              "){position:var(--pos,absolute);left:var(--l,0);top:var(--t,0);";
            m =
              m +
            ...
            m +=
              "width:" +
              parseInt(f.padding + 2 * f.controlBorderWidth + f.width + C) +
              "px;";
            m +=
              "height:" +
            ...
            m +=
              "." +
              u(M) +
              "{position:absolute;left:var(--cl,0);top:var(--ct,0);width:" +
              y +
              "px;height:" +
              y +
              "px}";
            e.crossBX.className = N;
            m +=
              "." +
              u(N) +
            ...
            m +=
              ...
              f.pointerThickness +
              "px;width:" +
              parseInt(y - 2 * f.pointerBorderWidth) +
              "px;";
            m +=
              "left:" +
              f.pointerBorderWidth +
              "px;top:" +
              parseInt(Math.floor(y / 2) - Math.floor(f.pointerThickness / 2)) +
              "px}";
            e.crossLY.className = Q;
            m +=
              "." +
              u(Q) +
              "{position:absolute;background:" +
            ...
            m +=
              "left:" +
              parseInt(f.padding + f.width + 2 * f.controlBorderWidth + 2 * C) +
              "px;";
            m +=
              "top:" +
              f.padding +
            ...
            m +=
              "left:" +
              parseInt(f.padding + f.width + 2 * f.controlBorderWidth + C) +
              "px;";
            m +=
              "top:0px;width:" +
              parseInt(f.sliderSize + 2 * C + 2 * f.controlBorderWidth) +
              "px;";
            m +=
              "height:" +
              parseInt(2 * f.controlBorderWidth + 2 * f.padding + f.height) +
            ...
            m +=
              ...
              "!important;";
            m +=
              "position:absolute;top:var(--at,0);left:" +
              -(2 * f.pointerBorderWidth + f.pointerThickness) +
              "px}";
            e.asldPtrMB.className = Z;
            m +=
              "." +
              u(Z) +
              "{border:" +
            ...
            b.picker.owner &&
              b.picker.owner !== f &&
              b.removeClass(
                b.picker.owner.targetElement,
                b.pub.activeClassName,
              );
            b.picker.owner = f;
            f.container === q.document.documentElement
              ? b.redrawPosition()
              : b._drawPosition(f, 0, 0, "relative", !1);
            e.wrap.parentNode !== f.container &&
              (m = b.node("dialog[id^='fr-dialog-']")) &&
              (m.appendChild(e.wrap),
              m.hasAttribute("open") && m.close && m.close(),
              (m.inert = !0),
          ...
          function l() {
            ...
            b.picker.cross.style.cssText =
              "--cl:" +
              parseInt(Math.round((f.channels.h / 360) * (f.width - 1)) + k) +
              "px;--ct:" +
              parseInt(e + k) +
              "px";
          ...
          function p() {
            ...
            e &&
              (b.picker.sldPtrOB.style.cssText =
                "--st:" +
                parseInt(
                  Math.round((1 - f.channels[e] / 100) * (f.height - 1)) -
                    (2 * f.pointerBorderWidth + f.pointerThickness) -
          ...
          this.channel = function (e, k) {
            if ("string" !== typeof e)
              throw Error("Invalid value for channel name: " + e);
            if ("undefined" === typeof k)
              return z.call(this.channels, e.toLowerCase())
          ...
          this.fromHSVA = function (e, k, r, t, y) {
            ...
            if (null !== t) {
              ...
              this.channels.a = this.hasAlphaChannel()
                ? Math.max(0, Math.min(1, this.maxA, t), this.minA)
                : 1;
            }
          ...
          this.fromRGBA = function (e, k, r, t, y) {
            ...
            e = b.RGB_HSV(
              ...
              null === k ? this.channels.g : k,
              null === r ? this.channels.b : r,
            );
            null !== e[0] &&
              (this.channels.h = Math.max(0, Math.min(360, e[0])));
            0 !== e[2] &&
              (this.channels.s = Math.max(
                0,
                this.minS,
                Math.min(100, this.maxS, e[1]),
              ));
            this.channels.v = Math.max(
              0,
              this.minV,
              Math.min(100, this.maxV, e[2]),
            );
            e = b.HSV_RGB(this.channels.h, this.channels.s, this.channels.v);
            this.channels.r = e[0];
            this.channels.g = e[1];
          ...
          this.fromString = function (e, k) {
            ...
            "any" === this.format.toLowerCase() &&
              ...
              b.isAlphaFormat(this.getFormat()) || (e.rgba[3] = 1));
          ...
          this.exposeColor = function (e) {
            ...
            if (!(e & b.flags.leaveValue) && this.valueElement) {
              if ("hex" === r || "hexa" === r)
                this.uppercase || (k = k.toLowerCase()),
                  this.hash || (k = k.replace(/^#/, ""));
              this.setValueElementValue(k);
            }
            e & b.flags.leavePreview ||
              !this.previewElement ||
          ...
          this.setPreviewElementBg = function (e) {
            if (this.previewElement) {
              ...
              b.isTextInput(this.previewElement) &&
                ((k = this.previewPosition), (r = this.previewSize));
              var t = [];
              t.push({ size: "auto" });
              if (e) {
                var y = b.genColorPreviewCanvas(
                  "rgba(0,0,0,0)",
                  k ? { left: "right", right: "left" }[k] : null,
                  r,
                  !0,
                );
          ...
          this.setValueElementValue = function (e) {
            this.valueElement &&
              ("input" === b.nodeName(this.valueElement)
                ...
                : (this.valueElement.textContent = e));
          };
          this._processParentElementsInDOM = function () {
            if (!this._parentElementsProcessed) {
              ...
              do {
                ...
                if (
                  (k.position && "fixed" === k.position.toLowerCase()) ||
          ...
          if (
            ...
            this.targetElement.frcp instanceof b.pub
          )
          ...
          -1 < ["auto", "any"].indexOf(this.format.toLowerCase())
            ? (this._currentFormat = (c = b.parseColorString(a))
                ? c.format
                : "hex")
