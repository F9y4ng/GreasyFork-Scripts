...
!(function () {
    ...
    S = (function () {
      var a = {
        ...
        isColorAttrSupported: (function () {
          ...
          return b.setAttribute && (b.setAttribute("type", "color"), "color" == b.type.toLowerCase()) ? !0 : !1;
        })(),
        ...
        parseColorString: function (b) {
          ...
          if ((e = b.match(/^\W*([0-9A-F]{3,8})\W*$|^currentcolor$/i))) {
            ...
            else if (6 === e[1].length) (d.format = "hex"), (d.rgba = [parseInt(e[1].substr(0, 2), 16), parseInt(e[1].substr(2, 2), 16), parseInt(e[1].substr(4, 2), 16), null]);
            else if (3 === e[1].length)
              (d.format = "hex"),
                (d.rgba = [parseInt(e[1].charAt(0) + e[1].charAt(0), 16), parseInt(e[1].charAt(1) + e[1].charAt(1), 16), parseInt(e[1].charAt(2) + e[1].charAt(2), 16), null]);
            else return !1;
            return d;
          }
          if ((e = b.match(/^\W*rgba?\(([^)]*)\)\W*$/i))) {
            ...
            if (3 <= b.length && (g = b[0].match(e)) && (h = b[1].match(e)) && (l = b[2].match(e)))
              return (
                (d.format = "rgb"),
                (d.rgba = [parseFloat(g[1]) || 0, parseFloat(h[1]) || 0, parseFloat(l[1]) || 0, null]),
        ...
        pub: function (b, d) {
          ...
          this.setValueElementValue = function (c) {
            this.valueElement && ("input" === a.nodeName(this.valueElement) ? (this.valueElement.value = c) : (this.valueElement.innerHTML = c));
          };
          this.setAlphaElementValue = function (c) {
            this.alphaElement && ("input" === a.nodeName(this.alphaElement) ? (this.alphaElement.value = c) : (this.alphaElement.innerHTML = c));
          };
  ...
  "undefined" === typeof window.FRColorPicker && (window.FRColorPicker = window.frColorPicker = S);
})();
