...
(function (p) {
    ...
    var a = {
      ...
      node: function (b) {
        ...
        if ("string" === typeof b) {
          var d = null;
          try {
            d = p.document.querySelector(b) || z.querySelector(b);
          } catch (e) {
            return null;
          }
          return d;
      ...
      setStyle: function (b, d, e, g) {
        ...
        for (l in d)
          if (a.hOP.call(d, l)) {
            var n = null;
            null === d[l]
              ? (k || (k = a.getData(b, "origStyle")), k && a.hOP.call(k, l) && (n = k[l]))
              : (g && (k || (k = a.getData(b, "origStyle", {})), a.hOP.call(k, l) || (k[l] = b.style[l])), (n = d[l]));
      ...
      parseColorString: function (b) {
        ...
        if ((d = b.match(/^\W*([0-9A-F]{3,8})\W*$/i))) {
          switch (d[1].length) {
            case 8:
              e.format = "hexa";
              e.rgba = [parseInt(d[1].slice(0, 2), 16), parseInt(d[1].slice(2, 4), 16), parseInt(d[1].slice(4, 6), 16), parseInt(d[1].slice(6, 8), 16) / 255];
              break;
            case 4:
              e.format = "hexa";
              e.rgba = [
            ...
            case 6:
              e.format = "hex";
              e.rgba = [parseInt(d[1].slice(0, 2), 16), parseInt(d[1].slice(2, 4), 16), parseInt(d[1].slice(4, 6), 16), 1];
              break;
            case 3:
              e.format = "hex";
              e.rgba = [parseInt(d[1].charAt(0) + d[1].charAt(0), 16), parseInt(d[1].charAt(1) + d[1].charAt(1), 16), parseInt(d[1].charAt(2) + d[1].charAt(2), 16), 1];
              break;
            default:
              return !1;
          }
        ...
        if ((d = b.match(/^\W*rgba?\(([^)]*)\)\W*$/i))) {
          ...
          d = /^\s*(\d+|\d*\.\d+|\d+\.\d*)\s*$/;
          var g, k, l, n;
          if (3 <= b.length && (g = b[0].match(d)) && (k = b[1].match(d)) && (l = b[2].match(d)))
            return (
              (e.format = "rgb"),
              (e.rgba = [parseFloat(g[1]) || 0, parseFloat(k[1]) || 0, parseFloat(l[1]) || 0, 1]),
              4 <= b.length && (n = b[3].match(d)) && ((e.format = "rgba"), (e.rgba[3] = parseFloat(n[1]) || 0)),
              e
            );
        }
        return !1;
      ...
      redrawPosition: function () {
        if (a.picker && a.picker.owner) {
          ...
          d = b.smartPosition
            ? [
                -e[l] + d[l] + n[l] > k[l] ? (-e[l] + d[l] + g[l] / 2 > k[l] / 2 && 0 <= d[l] + g[l] - n[l] ? d[l] + g[l] - n[l] : d[l]) : d[l],
        ...
        b.frcp && b.frcp instanceof a.pub
          ? b.frcp.showOnClick &&
            ...
            (a.picker && a.picker.owner
              ? (a.picker.owner.tryHide(), p.document.removeEventListener("mousedown", a.onDocumentMouseDown, !1))
              : (b.frcp.show(), p.document.addEventListener("mousedown", a.onDocumentMouseDown, !1)))
          : a.picker && a.picker.owner && (a.picker.owner.tryHide(), p.document.removeEventListener("mousedown", a.onDocumentMouseDown, !1));
      },
      onDocumentMouseDown: function (b) {
        if (!b.target || !b.target.nodeName || "fr-configure" !== b.target.nodeName.toLowerCase()) {
          ...
          } else a.picker && a.picker.owner && (a.picker.owner.tryHide(), p.document.removeEventListener("mousedown", a.onDocumentMouseDown, !1));
        }
      },
      ...
      createASliderGradient: function () {
        ...
        b.draw = function (g, k, l) {
          ...
          e.fillRect(0, 0, d.width, d.height);
          if (0 < g) for (var n = 0; n < d.height; n += 2 * g) (e.fillStyle = k), e.fillRect(0, n, g, g), e.fillRect(g, n + g, g, g);
          g = e.createLinearGradient(0, 0, 0, d.height);
          g.addColorStop(0, l);
      ...
      pub: function (b, d, e) {
        ...
        function k() {
          ...
          var c = a.picker,
            ...
            A = f.padding + f.width + 2 * f.controlBorderWidth + w + (h ? f.sliderSize + 2 * w + 2 * f.controlBorderWidth : 0);
          c.wrap.className = E;
        ...
        this.configShadow.addEventListener("click", a.onConfigIfMouseDown, !1);
  ...
  "undefined" === typeof p.FRColorPicker && (p.FRColorPicker = B);
  return B;
